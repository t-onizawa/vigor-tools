...
弘前ねぷたまつり運営委員会による8月1日〜7日の合同運行を対象とする。出陣式等は本体の補助情報に留め、周辺催事は混在させない。2026年表記は「令和8年度 弘前ねぷたまつり」、継続名称は「弘前ねぷたまつり」。

## 2026年・features・差異

弘前観光コンベンション協会と青森県公式情報で2026年8月1日〜7日、主催者、土手町・駅前コースを確認し、終了済みのため `ended`。ねぷたを山車、合同運行をパレードとして扱い、踊りは山車上ではない。既存の青森ねぶた祭と異なり、武者絵を描いた扇ねぷたを中心に城下町を運行する点をページの核とする。highlightCommentは公式の形状・囃子・掛け声の説明から作成した。
