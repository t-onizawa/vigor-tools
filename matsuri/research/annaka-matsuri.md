...
安中市公式で、例年10月中旬に行われる市民祭りであること、山車曳行は昭和24年に4町で復活し、その後参加地区が増えたことを確認した。山車は隔年で市街を巡り、出会った際に飾りと祭囃子を披露する。神輿は直近年度の市公式開催内容で確認した。

2026年の具体日程・山車実施内容は未発表のため、`eventStatus: unconfirmed`、`dates: []` とした。市役所前通りを主要観覧地点とし、神社所在地をmapReferenceにしていない。
...
- 市・観光系の公式公開元を検索。祭り固有性、投稿者、画質を直接確認できる背景・動画候補を特定できず、採用なし。
