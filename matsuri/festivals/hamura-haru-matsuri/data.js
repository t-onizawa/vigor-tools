const FESTIVAL = {
  ...
  constantInfo: {
    ...
    access: {
      nearestStation: "JR青梅線 羽村駅（西口広場に山車が集結）"
    },
    mapReference: {
      label: "羽村駅西口広場",
    ...
    confirmation: {
      ...
      sources: ["https://www.city.hamura.tokyo.jp/0000008921.html"]
    }
  },
  yearlyInfo: [
    {
      ...
      access: {
        hasParking: true,
        parkingNote: "羽村駅周辺に時間貸駐車場あり（SPT羽村駐車場・タイムズのB等）。イベント日は混雑が予想され予約制駐車場が推奨される。"
      },
      confirmation: {
        confirmedDate: "2026-07-28",
        sources: ["https://www.city.hamura.tokyo.jp/0000008921.html"],
        note: "羽村市公式サイトでは「市内神社春まつり」という名称が使われているが、第三者イベント情報サイト・氏子団体サイトでは「羽村春祭り（八雲神社春季例大祭）」という通称が広く使われている。八雲神社は現在稲荷神社に合祀されており、単独の神社としては現存しない。2026年単体の告知は確認できず、「4月第2土日」の恒常パターンからの計算値（4/11・12）を参考として一時掲載していたが、2026-09-04時点で公式サイトを再確認しても2026年個別の日程発表は無く、算出日程が過ぎた後も裏付けが取れなかったため、推測日付の掲載を取りやめ日程未発表の扱いに戻した。"
      }
    }
  ]
};
