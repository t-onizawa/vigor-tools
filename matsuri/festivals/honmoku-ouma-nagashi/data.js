const FESTIVAL = {
  ...
  areaTag: "kanagawa",
  constantInfo: {
    schedulePattern: "例年8月第1または第2日曜日を中心に開催",
    features: {
      hasDashi: "n/a",
      hasMikoshi: "n/a",
      hasDanceOnDashi: "n/a",
      ...
      hayashiNote: "茅で作った馬首亀体の「お馬さま」に災厄を託し、祭礼船で沖へ運ぶ送り神事。"
    },
    access: { nearestStation: "JR根岸線 根岸駅から路線バス「三の谷」下車" },
    mapReference: {
      label: "本牧神社",
      pointType: "shrine",
      query: "本牧神社 神奈川県横浜市中区",
      lat: null,
      lng: null,
      mapUrl: "https://www.google.com/maps/search/?api=1&query=本牧神社+神奈川県横浜市中区",
    ...
    confirmation: {
      ...
      sources: ["https://honmoku.or.jp/", "https://www.city.yokohama.lg.jp/kurashi/kyodo-manabi/bunkazai/bunya12000.files/0028_20241223.pdf"]
    }
  },
  yearlyInfo: [{
    year: 2026,
